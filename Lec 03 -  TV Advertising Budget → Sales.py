...
df = pd.read_csv("/content/drive/MyDrive/AI Engineer Roadmap/Module 03 - Machine Learning/advertising.csv")
print(df.head(5))
...
# Plot the regression line based on the model trained on the training data
